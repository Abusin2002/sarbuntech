...
<section class="service-hero py-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"
           data-aos="fade-right">
        <h1 class="fw-bold">Business Website Development</h1>
        <p class="mt-3">
          Build a professional, mobile-friendly website that helps your business grow online.
        </p>
...
<section class="py-5">
  <div class="container text-center"
       data-aos="zoom-in">
    <h2 class="fw-bold">What is Business Website?</h2>
    <p class="mt-3">
      A business website helps showcase your services, build trust with customers,
      and generate leads online using a professional digital presence.
    </p>
  </div>
</section>
