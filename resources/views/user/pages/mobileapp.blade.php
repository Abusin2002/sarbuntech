...
<section class="service-hero py-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"
           data-aos="fade-right">
        <h1 class="fw-bold">Mobile App Development</h1>
        <p class="mt-3">
         A mobile app is a tool that helps your business grow, connect with customers, and stay competitive in a mobile-first world.
        </p>
      ...
      <div class="col-lg-6 text-center py-4"
           data-aos="fade-left">
        <img src="{{ asset('assets/img/head/app.jpg') }}"
...
<section class="py-5">
  <div class="container text-center"
       data-aos="zoom-in">
    <h2 class="fw-bold">What is Mobile App Development?</h2>
    <p class="mt-3">
     Mobile app development is the process of creating software applications that run on smartphones and tablets, designed to perform specific tasks for users. These apps can be for iOS, Android, or both.
    </p>
  </div>
</section>
...
<div class="col-lg-6" data-aos="fade-left">
  ...
  <ul class="tick-list mt-3">
    <li><i class="bi bi-check-circle"></i> Custom Mobile App Development</li>
    <li><i class="bi bi-check-circle"></i> iOS & Android Support</li>
    <li><i class="bi bi-check-circle"></i> User-Friendly Design</li>
    <li><i class="bi bi-check-circle"></i> App Performance Optimization</li>
    <li><i class="bi bi-check-circle"></i> Ongoing Maintenance & Support</li>
  </ul>
</div>
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-4" data-aos="flip-left">
        <div class="card p-4 shadow">
          ...
          <ul class="tick-list mt-3">
            <li><i class="bi bi-check-circle"></i> Basic Mobile App</li>
      ...
      <div class="col-md-4" data-aos="flip-left" data-aos-delay="150">
        <div class="card p-4 shadow border-primary">
          <h4>Standard</h4>
          <div class="price"><sup>Rs.</sup>15999</div>
          <ul class="tick-list mt-3">
            <li><i class="bi bi-check-circle"></i> Advanced Mobile App</li>
      ...
      <div class="col-md-4" data-aos="flip-left" data-aos-delay="300">
        <div class="card p-4 shadow">
          <h4>Premium</h4>
          <div class="price"><sup>Rs.</sup>20999</div>
          <ul class="tick-list mt-3">
            <li><i class="bi bi-check-circle"></i> Premium Mobile App</li>
