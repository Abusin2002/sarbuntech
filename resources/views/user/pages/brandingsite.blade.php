...
<section class="service-hero py-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"
           data-aos="fade-right">
        <h1 class="fw-bold">Branding Website</h1>
        <p class="mt-3">
          Helping your business build a strong online presence that attracts and serves real customers.
        </p>
      ...
      <div class="col-lg-6 text-center py-4"
           data-aos="fade-left">
        <img src="{{ asset('assets/img/head/brand.jpg') }}"
...
<section class="py-5">
  <div class="container text-center"
       data-aos="zoom-in">
    <h2 class="fw-bold">What is Branding Website?</h2>
    <p class="mt-3">
     A branding website is a website that shows who your business is, what it stands for, and why people should trust it.

Its main goal is to build your brand, create a strong online presence, and connect with customers, rather than just sell products.
    </p>
  </div>
</section>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"
        ...
        <ul class="tick-list mt-3">
          <li><i class="bi bi-check-circle"></i> Custom Website Design</li>
          <li><i class="bi bi-check-circle"></i> Mobile Responsive</li>
          <li><i class="bi bi-check-circle"></i> Free Domain & Hosting</li>
